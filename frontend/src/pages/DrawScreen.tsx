    ...
    <>
      ...
      <Box className="bg-white w-full h-[88vh]">
        <div className="relative flex items-center justify-center">
          ...
          <div id="tier-container" className="w-[44vw] overflow-x-hidden scroll-smooth">
            <div 
        ...
        <Button onClick={handleShuffle} className="rounded-full font-bold text-lg mx-auto flex my-5 shadow-md shadow-gray-400 bg-foreground text-background px-7 py-7 hover:bg-gray-800">
          Shuffle
        </Button>
      </Box>
    </>
